...
export default function TaskList({ tasks, onTaskUpdated, onTaskDeleted, userId }) {
  ...
  const handleSave = async (taskId) => {
    ...
    if (
      isNaN(parseInt(editingTask.duration_minutes, 10)) ||
      isNaN(parseInt(editingTask.importance, 10)) ||
      isNaN(parseInt(editingTask.difficulty, 10))
    ) {
              ...
              <div className="space-y-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditingTask((prev) => ({
                          ...prev,
                          earliest_start_datetime:
                            e.target.value + 'T' + getTimePart(prev.earliest_start_datetime),
                        }))
                      }
                      className="p-2 border rounded"
                    />
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditingTask((prev) => ({
                          ...prev,
                          earliest_start_datetime:
                            getDatePart(prev.earliest_start_datetime) + 'T' + e.target.value,
                        }))
                      }
                      className="p-2 border rounded"
                    />
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditingTask((prev) => ({ ...prev, scheduling_type: e.target.value }))
                    }
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditingTask((prev) => ({ ...prev, duration_minutes: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditingTask((prev) => ({ ...prev, importance: e.target.value }))
                      }
                      min="1"
                      max="5"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditingTask((prev) => ({ ...prev, difficulty: e.target.value }))
                      }
                      min="1"
                      max="5"
